    ...
    <div className="min-h-screen">
      ...
      <section className="relative flex min-h-[85vh] items-center overflow-hidden">
        <div className="absolute inset-0">
          <img src="https://images.unsplash.com/photo-1494790108377-be9c29b29330?w=1200&q=80&sat=-100" alt="Luxurious wave hair collection" className="h-full w-full object-cover" />
